    ...
    with st.sidebar:
        ...
        big_sell_event = st.checkbox(
            ...
            help=(
                ...
                "이것은 단기 급락, 시장 신뢰도, 리스크 분석에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 연 1~2회 이하 발생이 일반적입니다."
            )
        )
        big_sell_prob = st.slider(
            ...
            help=(
                ...
                "이것은 하방 리스크, 가격 변동성, 투자자 이탈에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 5% 이하는 안정, 10% 이상은 고위험 신호입니다."
            )
        )
        pump_event = st.checkbox(
            ...
            help=(
                ...
                "이것은 단기 급등, 투자자 유입, 시장 과열에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 연 1~2회 이하가 일반적입니다."
            )
        )
        pump_prob = st.slider(
            ...
            help=(
                ...
                "이것은 단기 가격 급등, 변동성, 신규 진입자에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 5% 이하는 정상, 10% 이상은 과열 신호입니다."
            )
        )
        fund_inflow = st.slider(
            ...
            help=(
                ...
                "이것은 유동성 보강, 가격 방어력, 시장 신뢰도에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 월 시가총액의 1~5% 이내가 적정합니다."
            )
        )
        inflation_policy = st.selectbox(
            ...
            help=(
                ...
                "이것은 장기적 가치 희석, 투자자 신뢰, 가격 안정성에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 연 5% 이하는 저위험, 10% 이상은 고위험입니다."
            )
        )
        ai_strategy = st.selectbox(
            ...
            help=(
                ...
                "이것은 시뮬레이션 결과의 리스크/수익 프로파일에 영향을 미칩니다.\n"
                "거래소의 안전한 통계 기준: 전략 다양성 확보가 중요합니다."
            )
        )

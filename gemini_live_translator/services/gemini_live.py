...
def build_risk_prompt(
    ...
    return (
        ...
        "clarify_did_you_mean as a confirmation, and put the FULL corrected "
        "translation (the whole sentence as it should read, in the same language "
        "as LATEST TRANSLATION) in clarify_corrected_translation — it will "
        "REPLACE the displayed caption, so it must be a complete, natural "
        "sentence, not a note. Else false and empty.\n\n"
